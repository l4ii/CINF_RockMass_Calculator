...
describe('GSI project overview', () => {
  it('keeps the ledger before charts and unifies mixed entry paths', () => {
    ...
    expect(screen.getByTestId('gsi-overview-axis-caption')).toHaveTextContent('刻度 A')
    expect(screen.getByTestId('gsi-overview-axis-caption')).toHaveTextContent('刻度 B')
    expect(screen.getByTestId('gsi-overview-axis-caption').querySelectorAll('.katex').length).toBe(2)
